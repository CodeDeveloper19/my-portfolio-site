  ...
  return (
    ...
    <dropDownMenuContext.Provider value={[[isDropDownMenu, setIsDropDownMenu]]}>
      ...
      <main className='w-full normal:w-[1349px] h-fit flex flex-col items-center z-20'>
          ...
          <div className="max-w-[950px] minTablet:px-[50px] px-[20px] h-full flex pt-[120px] minTablet:pb-[200px] phone:pb-[150px] pb-[85px]">
            <div className="z-20 flex flex-col w-full h-full font-poppins">
              <div className="w-full max-w-[200px] border-b-[1px] pb-[10px] flex flex-row items-center">
                <span className="uppercase text-font9 phone:text-font7 font-[600] text-[#E6F1FF]">Hey there</span>
                <span className="text-font5 phone:text-font4 ml-[5px]">&#x1F44B;</span>
              </div>
              <h1 className="text-font2 phone:text-font1 font-[700] text-[#E6F1FF]">my name is <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-teal-400">okoli akachukwu</span></h1>
              <p className="text-font7 phone:text-font5 mt-[25px] font-[400] text-[#E6F1FFE6]">
        ...
        <section id="projects" className="max-w-[950px] px-[20px] minTablet:px-[50px] h-fit pt-[100px] phone:pt-[150px] flex flex-col font-poppins">
          <div className="w-full max-w-[200px] border-b-[1px] pb-[10px] flex flex-row items-center z-20">
            <p className="uppercase text-font9 phone:text-font7 font-[600] text-[#E6F1FF]">Few things i have built</p>
            <span className="text-font5 phone:text-font4 ml-[5px]">&#128104;&#8205;&#128187;</span>
          </div>
          <h2 className="text-font2 phone:text-font1 font-[700] w-full text-[#E6F1FF] z-20">my projects</h2>
          <p className="text-font7 phone:text-font5 mt-[25px] font-[400] text-[#E6F1FFE6] z-20">
          ...
          <div className="z-20 flex flex-col w-full h-fit mt-[30px] mb-[50px] phone:mb-[60px]">
        ...
        <section id="workexperience" className="max-w-[950px] px-[20px] minTablet:px-[50px] h-fit pt-[100px] phone:pt-[150px] flex flex-col font-poppins">
          <div className="w-full max-w-[200px] border-b-[1px] pb-[10px] flex flex-row items-center z-20">
            <p className="uppercase text-font9 phone:text-font7 font-[600] text-[#E6F1FF]">My Professional Experience with Companies</p>
            <span className="text-font5 phone:text-font4 ml-[10px]">💼</span>
          </div>
          <h2 className="text-font2 phone:text-font1 font-[700] w-full text-[#E6F1FF] z-20">work experience</h2>
          <p className="text-font7 phone:text-font5 mt-[25px] font-[400] text-[#E6F1FFE6] z-20">My professional journey has allowed me to work with dedicated teams, collaborate on exciting projects, and stay at the forefront of web and mobile development technologies. Below is a glimpse of my valuable experiences and contributions in the field of frontend development.</p>
          <div className="mt-[50px] flex flex-col w-full h-fit z-20">
            <h3 className="text-font5 phone:text-font4 text-[#E6F1FF]">Neulogics Solutions</h3>
            <div className="flex minLaptop:flex-row flex-col justify-between text-[#64ffd9] text-font8 phone:text-font6 mt-[10px] ml-[10px]">
            ...
            <ul className="ml-0 minTablet:ml-[30px] mt-[20px] list-none bullet w-full h-fit">
              <li className="text-[#E6F1FFE6] text-font8 phone:text-font6">I acquired the fundamental knowledge of front-end web development, encompassing key languages such as CSS, HTML, and JavaScript.</li>
              <li className="text-[#E6F1FFE6] text-font8 phone:text-font6 mt-[10px]">With guided learning and self-study, I gained proficiency in several front-end frameworks, including React, Bootstrap, and TailwindCSS.</li>
              <li className="text-[#E6F1FFE6] text-font8 phone:text-font6 mt-[10px]">Through user testing during its development phase, I provided feedback constantly to one of the company's crucial mobile applications.</li>            
              <li className="text-[#E6F1FFE6] text-font8 phone:text-font6 mt-[10px]">Partook in collaborative tasks with other employees of the company by editing various files and uploading them to Github through Git.</li>
            </ul>
          </div>
          <div className="mt-[50px] flex flex-col w-full h-fit z-20">
            <h3 className="text-font5 phone:text-font4 text-[#E6F1FF]">Trivance Technologies</h3>
            <div className="flex minLaptop:flex-row flex-col justify-between text-[#64ffd9] text-font8 phone:text-font6 mt-[10px] ml-[10px]">
        ...
        <section id="skills" className="max-w-[950px] px-[20px] minTablet:px-[50px] h-fit pt-[100px] phone:pt-[150px] flex flex-col font-poppins">
          <div className="w-full max-w-[200px] border-b-[1px] pb-[10px] flex flex-row items-center z-20">
            <p className="uppercase text-font9 phone:text-font7 font-[600] text-[#E6F1FF]">My Tools and Skills</p>
            <span className="text-font5 phone:text-font4 ml-[10px]">🛠️</span>
          </div>
          <h2 className="text-font2 phone:text-font1 font-[700] w-full text-[#E6F1FF] z-20">skillset</h2>
          <p className="text-font7 phone:text-font5 mt-[25px] font-[400] text-[#E6F1FFE6] z-20">I harness various programming languages and frameworks to create intuitive and interactive websites, and applications with a focus on user-centric design.</p>
          <div className="flex flex-col mt-[50px] minTablet:items-end items-center z-20 gap-[30px]">
            <h3 className="text-[#E6F1FF] text-font5 phone:text-font4 text-center">Frameworks and Libraries</h3>
            <div className="flex flex-col minTablet:flex-row gap-[40px] items-center text-font8 phone:text-font6">
          ...
          <div className="flex flex-col mt-[50px] minTablet:items-start items-center z-20 gap-[30px]">
            <h3 className="text-[#E6F1FF] text-font5 phone:text-font4 text-center">Languages</h3>
          ...
          <div className="flex flex-col mt-[50px] minTablet:items-end items-center z-20 gap-[30px]">
            <h3 className="text-[#E6F1FF] text-font5 phone:text-font4 text-center">Tools and Technologies</h3>
            <div className="flex flex-col minTablet:flex-row gap-[40px] items-center">
              <div className="flex flex-col items-center text-center w-fit h-fit text-[#E6F1FF]">
        ...
        <section id="contact" className="max-w-[950px] px-[20px] minTablet:px-[50px] h-fit pt-[100px] phone:pt-[150px] pb-[100px] flex flex-col font-poppins">
          <div className="w-full max-w-[200px] border-b-[1px] pb-[10px] flex flex-row items-center z-20">
            <p className="uppercase text-font9 phone:text-font7 font-[600] text-[#E6F1FF]">Contact</p>
            <span className="text-font5 phone:text-font4 ml-[10px]">📞</span>
          </div>
          <h2 className="text-font2 phone:text-font1 font-[700] w-full text-[#E6F1FF] z-20">talk to me</h2>
          <p className="text-font7 phone:text-font5 mt-[25px] font-[400] text-[#E6F1FFE6] z-20">Feel free to reach out if you have any inquiries, collaboration opportunities, or just want to say hello. I'm always excited to connect with fellow developers and enthusiasts. Looking forward to hearing from you!</p>
          <notificationContext.Provider value={[setNotificationIcon, setErrorTitle, setErrorMessage, setShowNotification, setIsLoading]}>
            <Contact></Contact>
      ...
      <section id="social_links" className="fixed bottom-[150px] hidden laptop:flex right-[-100px] flex-row items-center h-fit w-fit rotate-90 z-30">
          <a target="_blank" rel="noopener noreferrer" className="relative left-0 hover:left-[-10px] mr-[30px] transition-[left] duration-[400ms]" href='mailto:okoli555aka@gmail.com'><p className="text-[#e6f1ff] font-poppins text-font9 phone:text-font7">okoli555aka@gmail.com</p></a>
      ...
      <section className="fixed top-0 z-30 justify-center w-full h-screen notification" style={{display : (isLoading) ? 'flex' : 'none'}}>
        <div className="relative top-[50px] h-fit min-h-[80px] w-full max-w-[420px] border-[1px] border-white/[.3] rounded-[20px] flex flex-row z-10" style={{display : (showNotification) ? 'flex' : 'none', backgroundColor: (errorTitle === 'Success!' ? 'rgb(152, 251, 152)' : 'rgb(251, 206, 177)')}}>
            ...
            <div className="flex flex-col w-[70%] h-fit pt-[15px] text-[#191970]">
                <h3 id="error-title" className="text-font7 phone:text-font5 font-[700]">{errorTitle}</h3>
                <h5 id="error-message" className="text-font8 font-[400]">{errorMessage}</h5>
            </div>
            <button className="flex items-center justify-center w-fit" onClick={() => {setShowNotification(false); setIsLoading(false)}}>
